...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { filial: @gym.filial, physical_person_id: @gym.physical_person_id } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { filial: @gym.filial, physical_person_id: @gym.physical_person_id } }
